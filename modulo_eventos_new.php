      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="col-4">
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
              <label for="file_evento" class="form-label">File Evento</label>
              <span id="file_evento_error" class="text-danger"></span>
              <input type="file" class="form-control" id="file_evento" name="file_evento" placeholder="file_evento">
            </div>
            ...
            <div class="mb-3">
              <label for="hora_comienzo" class="form-label">Hora Comienzo</label>
              <span id="hora_comienzo_error" class="text-danger"></span>
              <input type="text" class="form-control" id="hora_comienzo" name="hora_comienzo" placeholder="hora_comienzo">
            </div>
