...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="formapago" name="formapago" placeholder="Forma de pago">
</div>
    ...
    $("#btnform1").click(function(){
       // Swal.fire("SweetAlert2 is working!");
        ...
        if(error==0){
            //$("#form1").submit();
             $.ajax({
                 data:{razon_social:razon_social,nombre_comercial:nombre_comercial,cif:cif,formapago:formapago},
                 method:"POST",
