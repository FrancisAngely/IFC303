        ...
        <div class="col-4">
          <form action="#" method="post" enctype="multipart/form-data" id="form1">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="entrada" name="entrada" placeholder="Entrada" value="<?php echo $user["entrada"]; ?>">
            </div>
            ...
            <div class="mb-3">
              ...
              <select class="form-control" id="id_eventos" name="id_eventos">
                <option></option>
                <?php echo SelectOptionsIdSel("eventos", "evento", $user["id_eventos"]); ?>
              </select>
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="precio" name="precio" placeholder="precio" value="<?php echo $user["precio"]; ?>">
            </div>
    ...
    $(document).ready(function() {
      ...
      $("#btnform1").click(function() {
        ...
        if (entrada == "") {
          ...
          error = 1;
          $("#entrada_error").html("Debe introducir una entrada");
        ...
        if (id_eventos == "") {
          ...
          error = 1;
          $("#id_eventos_error").html("Debe introducir un id de evento");
